...
Once you've created a `clockwork.yml` file in the root of your repository, you can add your package to the registry. This will allow users to install your package without needing to provide a URL.
